...
import 'package:aqueduct_mysql/src/cli/commands/auth_add_client.dart';
import 'package:aqueduct_mysql/src/cli/commands/auth_scope.dart';

class CLIMySqlAuth extends CLICommand {
  CLIMySqlAuth() {
    registerCommand(CLIMySqlAuthAddClient());
    registerCommand(CLIMySqlAuthScopeClient());
  }
