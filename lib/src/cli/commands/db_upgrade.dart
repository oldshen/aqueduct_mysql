...
import 'package:aqueduct_mysql/src/cli/scripts/run_upgrade.dart';
import 'package:isolate_executor/isolate_executor.dart';
import 'package:sqljocky5/connection/connection.dart';

/// Used internally.
class CLIMySqlDatabaseUpgrade extends CLICommand
    with CLIMySqlDatabaseConnectingCommand, CLIDatabaseManagingCommand, CLIProject {
  @override
  ...
  Future<Schema> executeMigrations(List<MigrationSource> migrations,
    ...
    final schemaMap = await IsolateExecutor.run(
        RunMySqlUpgradeExecutable.input(
            fromSchema, _storeConnectionInfo, migrations, fromVersion),
        packageConfigURI: packageConfigUri,
        imports: RunMySqlUpgradeExecutable.imports,
  ...
  DBInfo get _storeConnectionInfo {
    ...
    if (s is MySqlPersistentStore) {
      ConnectionSettings c=s.connectionSettings;

      return DBInfo("mysql", c.user, c.password, c.host, c.port,
          c.db, "UTC");
    }
